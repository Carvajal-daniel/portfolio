...
const TextIntro = () => {
  ...
  return (
    <div className="w-screen px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 py-10">
      <div className="w-full">
        <div className="mb-8">
          <h1
            className={`${bebasNeue.className} z-50 text-[5rem] leading-20 md:text-8xl 2xl:text-9xl text-white -mt-1`}
          ...
          <h2
            className={`${bebasNeue.className} text-white text-[1.9rem] md:text-lg font-bold lg:text-xl mt-2 leading-8 transform transition-all duration-600 ease-out ${
              animationPhase >= 3
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-6"
            }`}
          >
            Transformando <br /> ideias em experiências digitais
          </h2>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          <Link href="#contact" className="w-full md:w-auto">
            <button
              ...
              className={`w-full mt-2 md:w-auto px-6 py-3 md:px-8 md:py-4 
              bg-gradient-to-r from-orange-500 to-pink-500 
              text-white font-semibold rounded-lg transition-all shadow-lg hover:shadow-xl 
              transform hover:scale-105 active:scale-95 flex items-center gap-2 justify-center
              ${
                animationPhase >= 3
