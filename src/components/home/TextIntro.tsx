...
const TextIntro = () => {
  ...
  return (
    <div className="w-full md:w-1/2 lg:w-[50%]">
      <div className="mb-8">
        <h1
          className={`${bebasNeue.className} z-50 text-8xl md:text-8xl 2xl:text-9xl text-white mt-4`}
        ...
        <h2
          className={`${bebasNeue.className} text-white text-[1.5rem] md:text-lg font-bold lg:text-xl mt-0 leading-8 transform transition-all duration-600 ease-out ${
            animationPhase >= 3
              ? "opacity-100 translate-y-0"
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-4">
        <Link href="#contact" className="w-full -mt-6 md:w-auto">
          <button
            aria-label="Baixar Currículo"
            className={`w-full mt-4 md:w-auto px-6 py-3 md:px-8 md:py-4 
